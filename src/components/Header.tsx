...
export default function Header({ dict }: HeaderProps) {
  ...
  const navLinks = [
    { href: "/reportar", label: dict.report, icon: <Bird className="h-5 w-5" /> },
    { href: "/reports", label: dict.reports, icon: <List className="h-5 w-5" /> },
    { href: "/acerca-de", label: dict.about, icon: <Info className="h-5 w-5" /> },
  ];
